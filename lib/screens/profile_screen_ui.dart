/// project 1
/// profile_making_ui_one

import 'package:flutter/material.dart';
import 'package:ui_learning_project/core/common_widgets/common_button.dart';
import 'package:ui_learning_project/screens/second_ui_screen.dart';

class ProfileLearningScreen extends StatefulWidget {
  const ProfileLearningScreen({Key? key}) : super(key: key);

  @override
  State<ProfileLearningScreen> createState() => _ProfileLearningScreenState();
}

class _ProfileLearningScreenState extends State<ProfileLearningScreen> {
  @override
          ...
          CommonButtonsScreen(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const FoxUiScreen(),
                ),
              );
            },
          ),
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage("assets/images/img_girl.png.jpeg"),
                        fit: BoxFit.cover),
                  ),
                ),
                Container(
